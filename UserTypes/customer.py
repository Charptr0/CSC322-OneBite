...
class Customer(User):
    ...
    def makeComment(self, db, dt):
        ...
        if "compliment-dish-submit" in request.form:
            ...
            cursor.execute('INSERT INTO compliments(first_name, last_name, customer_id, recipient_id, compliment_date, compliment_content) VALUES (%s, %s, %s, %s, %s, %s)', (self.firstName, self.lastName, str(self.id), str(recipient_id), dt, content))
        ...
        if "complaint-dish-submit" in request.form:
            ...
            chef_id = cursor.fetchone()
            recipient_id = chef_id["chef"]
            cursor.execute('INSERT INTO complaint(first_name, last_name, customer_id, recipient_id, complaint_date, complaint_content) VALUES (%s, %s, %s, %s, %s, %s)', (self.firstName, self.lastName, str(self.id), str(recipient_id), dt, content))
